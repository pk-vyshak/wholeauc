...
<?php
     ...
     <!--body-->
     <div id="bg1">
                <span id="arrowcart"><i class="fa-solid fa-cart-circle-arrow-up"></i></span>
                <form action="" method="post">
                    <span class="usericn"><i class="fa-solid fa-user-vneck"></i></span><input type="text" id="namelp" name="username" required placeholder="ADMINNAME">
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($count==1)
        {
            ...
            header('location:'.SITEURL.'/admin/amain.php');
        }
        else
        {

            $_SESSION['login'] = "<div class='error'>Username or Password did not match.</div>";
            header('location:'.SITEURL.'/admin/alogin.php');
        }
